...
function ToastMessage({ exercise, isSuccessMessage, toastMessageStyles }) {
  if (isSuccessMessage){
    return (
        <div id="toast-success"
            style={ toastMessageStyles.toastMessage }
            ...
            <div className="ml-3 text-sm font-normal">{exercise.name } added successfully.</div>
    ...
    return (
      ...
      <div className="ml-3 text-sm font-normal">Could not add { exercise.name }</div>
